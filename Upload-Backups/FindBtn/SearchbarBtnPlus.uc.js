...
//		this.currentEngine = this.engines ? this.engines[2] : this._engines[2];
	...
	findMatchCase.setAttribute('onclick', 'if (event.button == 2) {gFindBar.toggleHighlight(0);document.getElementById("searchbar").value="";gFindBar._foundMatches.hidden = true;event.preventDefault();}');
