(function TabContextMenuButton() {

	var newBtn = document.getElementById("TabsToolbar");
	var TabContextMenuBtn = document.createElement("toolbarbutton");
	TabContextMenuBtn.id = "TabContextMenu-button";
	TabContextMenuBtn.setAttribute("label", "分頁選單按鈕");
	TabContextMenuBtn.setAttribute("class", "toolbarbutton-1 chromeclass-toolbar-additional");
	TabContextMenuBtn.setAttribute("type", "menu");
	TabContextMenuBtn.style.listStyleImage = "url(data:image/png;base64,)";
	TabContextMenuBtn.setAttribute("tooltiptext", "左鍵：分頁選單");
	newBtn.appendChild(TabContextMenuBtn);

	var tabContextPopup = document.getElementById("tabContextMenu");
