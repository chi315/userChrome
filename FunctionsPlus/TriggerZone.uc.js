	...
	TriggerZone = {
		init: function() {
			this.icon = $("appcontent").appendChild($C("hbox", {
				...
				class: "toolbar",
				tooltiptext: "觸發區域",
				style: "position: fixed; right: 16px; bottom: 16px; background: -moz-linear-gradient(top, rgb(252, 252, 252) 0%, rgb(245, 245, 245) 33%, rgb(245, 245, 245) 100%); opacity: 0.9; min-width: auto; max-width: 166px; border: 2px solid rgb(144,144,144); border-radius: 5px;",
			}));
